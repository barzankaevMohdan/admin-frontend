# 🚀 Admin Frontend - Установка и запуск на macOS
...
2. Hot Module Replacement (HMR) работает автоматически в dev режиме

3. TypeScript проверки можно запустить отдельно:
   ```bash
   npm run type-check
   ```
